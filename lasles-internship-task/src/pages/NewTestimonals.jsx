...
function NewTestimonals() {
  ...
  return (
    <div className="w-[70%] h-[80vh] grid grid-cols-1 content-evenly m-auto">
      ...
      <div
        ...
        className="testimonial_container w-[100vw] grid grid-cols-1 content-between xs:h-[220px] lg:h-[230px] m-auto scroll-smooth overflow-x-auto"
      >
      ...
      <div className="flex justify-between items-center">
        ...
        <div className="flex gap-5">
          <button onClick={() => handleClick("left")}>
            <BsArrowLeftCircleFill className="text-laslesOrange text-5xl" />
          </button>
          <button onClick={() => handleClick("right")}>
            <BsArrowRightCircleFill className="text-laslesOrange text-5xl" />
          </button>
        </div>
      </div>
    </div>
